...
//                      pipes.Do(aDataProcessor).Outputs(anotherDataProcessor),
//                      // ...
//             ),
//             // ...
//     )
//
// Notice how the pipes.Do() and Outputs() functions allow you to insert
...
//
// See the pipes package documentation for more code examples.
